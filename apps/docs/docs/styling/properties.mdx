...
Ring color around today's date number in the DAY/WEEK header and the RESOURCE header. Also used
as the highlight color for the drag-over target cell in RESOURCE.
...
Text color for weekend day names and numbers in the DAY/WEEK header and the RESOURCE header. Not
