...
// HTMLMhCalendarElement is a global ambient type generated by Stencil (like HTMLDivElement) —
// no import needed, it's available once the loader's types are in the program.
